...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/deliveryaddress-server-33100/src/main/java");
...
//         String templatePath = "/templates/mapper.xml.vm";
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/deliveryaddress-server-33100/src/main/resources/mapper/" + pc.getModuleName()
        ...
        */
        ...
        //strategy.setSuperEntityClass("com.wanli.common.BaseEntity");
        strategy.setEntityLombokModel(true);  //lombok模型
        strategy.setRestControllerStyle(true);  //resutFul风格控制器
        // 公共父类--所有项目 控制器的父类
        strategy.setSuperControllerClass("com.wanli.common.BaseController");
        // 写于父类中的公共字段
